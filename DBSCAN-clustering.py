...
centroidLocation: Coordinates of the centroids that will generate random data.
...
def create_data_points(centroid_location, num_samples, cluster_deviation):
    ...
    X, y = make_blobs(n_samples=num_samples, centers=centroid_location,
                      cluster_std=cluster_deviation)
...
# understand differences between partitional and density-based clustering,
